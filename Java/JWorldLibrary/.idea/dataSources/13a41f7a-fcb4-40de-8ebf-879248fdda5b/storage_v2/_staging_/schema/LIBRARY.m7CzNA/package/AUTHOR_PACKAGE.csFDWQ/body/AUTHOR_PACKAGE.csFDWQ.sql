...
-- 通过作者名查询作者的信息
PROCEDURE FIND_AUTHOR_INFO (V_NAME IN VARCHAR2, V_COUNTRY OUT VARCHAR2)
IS
BEGIN
	SELECT COUNTRY 
	INTO V_COUNTRY
...
-- 向作者表中插入作者编号
PROCEDURE INSERT_INTO_AUTHOR (V_NAME IN VARCHAR2, V_COUNTRY IN VARCHAR2,V_NO OUT NUMBER)
IS
	P_COUNT NUMBER;
BEGIN
	SELECT COUNT(*)
